                ...
                <tbody>
                  {attentionList.slice(0, 8).map((inv) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5 text-sm font-mono font-bold text-gray-900 dark:text-gray-100 text-right">{formatCurrency(inv.total, inv.currency)}</td>
                ...
                {recentInvoices.map((inv) => (
                  ...
                  >
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-sm font-mono font-bold text-gray-900 dark:text-gray-100">{formatCurrency(inv.total, inv.currency)}</p>
