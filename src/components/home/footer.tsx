  ...
  return (
    <footer className="border-t border-gray-800 bg-gray-950">
      <div className="mx-auto max-w-6xl px-6 py-20 lg:py-24">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-800 text-gray-500 transition-colors hover:border-gray-400 hover:text-gray-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
              >
        ...
        {/* Bottom bar */}
        <div className="mt-16 flex justify-center border-t border-gray-800 pt-8">
