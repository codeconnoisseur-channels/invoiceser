...
export async function GET(
  ...
  try {
    ...
    const styles = StyleSheet.create({
      ...
      companyName: { fontSize: 13, fontWeight: "bold", color: accent, marginBottom: 2 },
      headerMeta: { fontSize: 8, color: "#6b7280", marginTop: 1 },
      invoiceTitle: { fontSize: 22, fontWeight: "bold", color: "#111827" },
      invoiceNumber: { fontSize: 10, color: "#6b7280", fontFamily: "Helvetica", marginTop: 3 },
      dateLine: { fontSize: 8, color: "#9ca3af", marginTop: 6 },
      dateValue: { fontSize: 8, color: "#374151" },
      billToBand: {
        backgroundColor: accentLight,
        paddingHorizontal: 40,
        paddingVertical: 10,
      },
      billToLabel: { fontSize: 7, fontWeight: "bold", textTransform: "uppercase", letterSpacing: 1.5, color: accent, marginBottom: 3 },
      billToName: { fontSize: 10, fontWeight: "bold", color: "#111827" },
      billToSub: { fontSize: 8, color: "#6b7280", marginTop: 1 },
      tableContainer: { paddingHorizontal: 40, paddingTop: 18 },
      tableHeader: {
        flexDirection: "row",
      ...
      tableRow: { flexDirection: "row", paddingVertical: 6, paddingHorizontal: 6 },
      tableRowAlt: { flexDirection: "row", paddingVertical: 6, paddingHorizontal: 6, backgroundColor: "#f9fafb" },
      colDesc: { flex: 3 },
      colRight: { flex: 1, textAlign: "right" },
      cellText: { fontSize: 8, color: "#374151" },
      cellMono: { fontSize: 8, color: "#374151", fontFamily: "Helvetica" },
      totalsContainer: { paddingHorizontal: 40, paddingTop: 8 },
      totalsRow: { flexDirection: "row", justifyContent: "flex-end", marginTop: 3 },
      totalLabel: { width: 110, textAlign: "right", fontSize: 8, color: "#6b7280" },
      totalValue: { width: 80, textAlign: "right", fontSize: 8, fontFamily: "Helvetica", color: "#374151" },
      grandTotalRow: {
        flexDirection: "row",
      ...
      grandTotalLabel: { width: 110, textAlign: "right", fontSize: 10, fontWeight: "bold", color: accent },
      grandTotalValue: { width: 80, textAlign: "right", fontSize: 10, fontWeight: "bold", fontFamily: "Helvetica", color: accent },
      divider: { borderBottomWidth: 1, borderBottomColor: "#e5e7eb", marginTop: 8 },
      sectionContainer: { paddingHorizontal: 40, paddingTop: 18 },
      sectionLabel: { fontSize: 7, fontWeight: "bold", textTransform: "uppercase", letterSpacing: 1.5, color: accent, marginBottom: 6 },
      sectionText: { fontSize: 8, color: "#4b5563", lineHeight: 1.7 },
      footer: {
        position: "absolute",
        bottom: 0,
        left: 0,
      ...
      footerBrand: { fontSize: 6, color: "#d1d5db", textAlign: "center", marginTop: 2 },
      voidWatermark: {
