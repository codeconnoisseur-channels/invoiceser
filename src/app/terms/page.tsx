    ...
    <div className="min-h-screen bg-gray-950 text-white selection:bg-primary-900 selection:text-primary-100">
      ...
      <section className="bg-gray-900/50 py-20 border-b border-gray-800">
        <div className="mx-auto max-w-5xl px-6">
          <h1 className="text-5xl font-extrabold text-white mb-4 tracking-tight">Terms of Service</h1>
      ...
      <main className="mx-auto max-w-5xl px-6 py-20 flex flex-col md:flex-row gap-12 items-start">
        ...
        <div className="w-full md:w-64 shrink-0 bg-gray-900 rounded-2xl p-6 border border-gray-800 sticky top-10">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#user-accounts" className="block px-4 py-2.5 rounded-lg text-gray-400 hover:bg-gray-800 hover:text-white font-semibold text-sm transition-colors">
                2. User Accounts & Access
              </a>
            </li>
            <li>
              <a href="#acceptable-use" className="block px-4 py-2.5 rounded-lg text-gray-400 hover:bg-gray-800 hover:text-white font-semibold text-sm transition-colors">
                3. Acceptable Use Policy
              </a>
            </li>
            <li>
              <a href="#fees-billing" className="block px-4 py-2.5 rounded-lg text-gray-400 hover:bg-gray-800 hover:text-white font-semibold text-sm transition-colors">
                4. Fees and Billing
              </a>
            </li>
            <li>
              <a href="#modifications" className="block px-4 py-2.5 rounded-lg text-gray-400 hover:bg-gray-800 hover:text-white font-semibold text-sm transition-colors">
        ...
        <div className="flex-1 space-y-12">
          ...
          <section id="user-accounts" className="scroll-mt-10">
            <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">2. User Accounts & Access</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <ul className="list-disc pl-6 space-y-3 text-gray-400 leading-relaxed">
              <li><strong className="text-gray-200">Account Security:</strong> You are solely and entirely responsible for maintaining the strict confidentiality of your account credentials (email and password). You agree to notify our security team immediately of any unauthorized access, suspected breach, or any other breach of security.</li>
              <li><strong className="text-gray-200">Eligibility:</strong> You must be at least 18 years of age (or the age of legal majority in your jurisdiction) to create an Invoiceser account and utilize our billing infrastructure.</li>
              <li><strong className="text-gray-200">Account Suspension:</strong> We reserve the right to suspend or terminate your account—without prior notice or liability—if we determine, at our sole discretion, that you have violated these Terms or engaged in unauthorized or fraudulent activity.</li>
            </ul>
          </section>

          <section id="acceptable-use" className="scroll-mt-10">
            <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">3. Acceptable Use Policy</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
          ...
          <section id="fees-billing" className="scroll-mt-10">
            <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">4. Fees and Billing</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <ul className="list-disc pl-6 space-y-3 text-gray-400 leading-relaxed">
              <li><strong className="text-gray-200">Subscription Cycles:</strong> Pro subscriptions are billed in advance on a recurring monthly or annual basis, depending on the plan you select at checkout.</li>
              <li><strong className="text-gray-200">Payment Processing:</strong> By subscribing, you authorize us (via our third-party payment processor) to automatically charge your payment method on file on the renewal date.</li>
              <li><strong className="text-gray-200">Refunds:</strong> Subscription fees are non-refundable, except as explicitly required by local law. You may cancel your subscription at any time to prevent future billing.</li>
            </ul>
          </section>

          <section id="modifications" className="scroll-mt-10">
            <h2 className="text-3xl font-extrabold text-white mb-4 tracking-tight">5. Modifications to Service</h2>
            <p className="text-gray-400 leading-relaxed">
